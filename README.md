...
# 📖 [Leaderbord_Project] <a name="about-project"></a>

**[Leaderbord_Project]** The "leaderboard" website displays scores submitted by different players. It also allows you to submit your score. All data is preserved
...
`https://github.com/Ouail-01/Leaderboard_Project.git`
...
- Create a collection that keeps the score.
- Add a functionality that allows users the score at leaderboard
- Display all saved score in the collection on the page
